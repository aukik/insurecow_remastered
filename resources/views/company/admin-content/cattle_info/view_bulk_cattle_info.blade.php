                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            @foreach($cattle_data as $cattle)
                                ...
                                <div>
                                    <h4>Cattle Info : {{ $cattle->cattle_name }} - Farmer Name : {{ \App\Models\User::find($cattle->user_id)->name ?? "Farmer name not found" }}</h4>
                                    <hr>
                                    ...
                                    <div>
                                        ...
                                        <div class="row gx-3 mb-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                >Farmer Name</label
                                                ><span style="color: red"></span>
                                                <p>{{ \App\Models\User::find($cattle->user_id)->name ?? "Farmer name not found" }}</p>
