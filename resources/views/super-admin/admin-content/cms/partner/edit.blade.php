        ...
        <div class="container-xl px-4 mt-4">
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">Update Partner- Super Admin</div>
                        <div class="card-body">
                            ...
                            <form action="{{route('partner.update',$partner->id)}}" method="Post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="exampleInputEmail1" aria-describedby="emailHelp"
                                                   placeholder="" name="title" value="{{$partner->title}}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" id="exampleInputEmail1" aria-describedby="emailHelp"
                                                   placeholder="" name="description"
                                                      class="form-control @error('title') is-invalid @enderror">{{$partner->description}}</textarea>
                                    ...
                                    <div class="col-md-12" style="margin-top: 15px">
                                        <input type="submit" value="Update Partner" class="btn btn-success">
                                    </div>
