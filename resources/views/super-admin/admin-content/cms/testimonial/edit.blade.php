        ...
        <div class="container-xl px-4 mt-4">
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">Update testimonial- Super Admin</div>
                        <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="exampleInputEmail1" aria-describedby="emailHelp"
                                                   placeholder="" name="title" value="{{$testimonial->title}}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" id="exampleInputEmail1" aria-describedby="emailHelp"
                                                   placeholder="" name="description"
                                                      class="form-control @error('title') is-invalid @enderror">{{$testimonial->description}}</textarea>
