                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('register_cattle_from_super_admin_side.store') }}" method="post"
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <label class="small mb-1" for="inputLastName">Farm Name</label><span
                                    ...
                                    <div class="col-md-4">
                                        <label class="small mb-1" for="inputLastName">Animal Type</label><span
                                            style="color: red">*</span>
                                    ...
                                    <div class="col-md-4">
                                        <label class="small mb-1" for="inputLastName">Animal Name</label><span
                                            style="color: red">*</span>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <label class="small mb-1" for="inputLastName">Animal Breed</label><span
                                            style="color: red">*</span>
                                        <input class="form-control" id="inputLastName" type="text" placeholder=""
                                    ...
                                    <div class="col-md-4">
                                        <label class="small mb-1" for="inputLastName">Animal Age</label><span
                                            style="color: red">*</span>
                                        <input class="form-control" id="inputLastName" type="text" placeholder=""
                                    ...
                                    <div class="col-md-4">
                                        <label class="small mb-1" for="inputLastName">Animal Color</label><span
                                            style="color: red">*</span>
                                        <input class="form-control" id="inputLastName" type="text" placeholder=""
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <label class="small mb-1" for="inputLastName">Sum Insured</label><span
                                            style="color: red">*</span>
                                    ...
                                    <div class="col-md-4">
                                        <label class="small mb-1" for="inputLastName">Animal Weight</label><span
                                            style="color: red">*</span>
                                        <input class="form-control" id="inputLastName" type="number" placeholder=""
                                    ...
                                    <div class="col-md-4">
                                        <label class="small mb-1" for="inputOrgName">Animal With Owner</label><span
                                            style="color: red"></span>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <label class="small mb-1" for="inputOrgName">Animal Left Side</label><span
                                            style="color: red">*</span>
                                        <input type="file" class="form-control" name="left_side">
                                    ...
                                    <!-- Form Group (organization name)-->
                                    <div class="col-md-4">
                                        <label class="small mb-1" for="inputOrgName">Animal Right Side</label><span
                                            style="color: red">*</span>
                                    ...
                                    <!-- Form Group (organization name)-->
                                    <div class="col-md-4">
                                        <label class="small mb-1" for="inputOrgName">Special Marks</label><span
                                            style="color: red">*</span>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <label class="small mb-1" for="inputLastName">Animal Gender Type</label><span
                                            style="color: red">*</span>
                                    ...
                                    <div class="col-md-4" id="muzzle_of_cow">
                                        <label class="small mb-1" for="inputOrgName">Muzzle Of Animal</label><span
                                            style="color: red">*</span>
                                        <input type="file" class="form-control" name="muzzle_of_cow" id="fileInput">
                                    ...
                                    <div class="col-md-4">
                                        <label class="small mb-1" for="inputLastName">Registration for Farmer</label><span
                                            style="color: red"></span>
                                        <input class="form-control" id="inputLastName" type="text" placeholder=""
                                            value="{{ $farmer->name }}" readonly name="user_name"
                                    ...
                                    <div class="col-md-4">
                                        <label class="small mb-1" for="inputLastName" style="display: none">Farmer ID
                                            Information</label><span style="color: red"></span>
                                        <input class="form-control" id="inputLastName" type="hidden" placeholder=""
                                            value="{{ $farmer->id }}" readonly name="user_id_info"
                                            style="background-color: white" />
