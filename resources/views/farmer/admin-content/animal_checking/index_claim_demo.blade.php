                    ...
                    >
                        <div class="col-auto mb-3">
                            <h1 class="page-header-title">
                                ...
                                Animal Information Checking - Farmer<span style="color: red">&nbsp</span>
                            </h1>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-xl px-4 mt-4">
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">Animal Information Checking - Farmer<span
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('instant_animal_info_checking.store') }}" method="post"
