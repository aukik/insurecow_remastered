...
{{--                                    <div class="text-lg fw-bold">4</div>--}}
                        ...
                        <div
                            class="card-footer d-flex align-items-center justify-content-between small"
                        >
                            <a class="text-white stretched-link" href="{{ route('sp.registered_resources') }}"
                            >View Information</a
                            >
                            <div class="text-white">
                                <i class="fas fa-angle-right"></i>
...
{{--                                    <div class="text-lg fw-bold">1492</div>--}}
                        ...
                        <div
                            class="card-footer d-flex align-items-center justify-content-between small"
                        >
                            <a class="text-white stretched-link" href="{{ route('sp.user_history') }}"
                            >View Information</a
                            >
                            <div class="text-white">
                                <i class="fas fa-angle-right"></i>
...
{{--                                    <div class="text-lg fw-bold">11865</div>--}}
            ...
            {{-- ---------------------------------------- Cattle registration breakdown and other options ---------------------------------------- --}}
