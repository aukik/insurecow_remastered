                ...
                <div class="col-lg-6 col-xl-3 mb-4">
                    <div class="card bg-purple text-white h-100">
                        <div class="card-body">
                            ...
                            >
                                <div class="me-3">
                                    <div class="text-white-75 small">No Of Firms</div>
                ...
                <div class="col-lg-6 col-xl-3 mb-4">
                    <div class="card bg-primary text-white h-100">
                        <div class="card-body">
                            ...
                            >
                                <div class="me-3">
                                    <div class="text-white-75 small">Cattle Registration Verification Report Count</div>
                                    <div class="text-lg fw-bold">{{ $cattle_reg_verification_count }}</div>
                                </div>
                                <i
                                    class="feather-xl text-white-50"
                                    data-feather="message-circle"
                        ...
                        <div
                            class="card-footer d-flex align-items-center justify-content-between small"
                        >
                            <a class="text-white stretched-link" href="{{ route('registration_verification_reports') }}"
                            >View Reports</a
                            >
                            <div class="text-white">
                                <i class="fas fa-angle-right"></i>
