            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-4">
                    ...
                    <div class="card h-100 border-start-lg border-start-info">
                        <div class="card-body">
                            <div class="small text-muted">No of animal</div>
                            <div class="h3">{{ $no_of_cattle }}</div>
                            <a class="text-arrow-icon small" href="{{ route('cattle.list') }}">
                                View Animals
                ...
                <div class="col-lg-4 mb-4">
                    ...
                    <div class="card h-100 border-start-lg border-start-warning">
                        <div class="card-body">
                            <div class="small text-muted">Cattle Verification Report</div>
                            <div class="h3">{{ $cattle_reg_verification_count }}</div>
                            <a class="text-arrow-icon small" href="{{ route('registration_verification_reports') }}">
                                View Reports
                                <i data-feather="arrow-right"></i>
                            </a>
                        </div>
                ...
                <div class="col-xl-12 col-xl-12 mb-4">
                    <div class="card card-header-actions h-100">
                        <div class="card-header">
                            Animal registration verification reports
                                ...
                                @foreach($cattle_reg_verification as $verification)
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-item-content">
                                            <b>{{ Str::ucfirst($verification->operation) }} Report</b> - verification
                                            for <b
                                                style="color: #6f0a00"> {{ $verification->cattle_name }} </b> - <b
                                                style="color: #0a3622">{{ Str::ucfirst($verification->verification_report)  }}</b>
                                            - <b>{{ $verification->created_at->format('d-m-Y') }}</b>
                                        </div>
                                    </div>
