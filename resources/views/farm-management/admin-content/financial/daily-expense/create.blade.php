                    ...
                    >
                        <div class="col-auto mb-3">
                            <h1 class="page-header-title">
                                ...
                                Farm Management - Daily Expense Information
                            </h1>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-xl px-4 mt-4">
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">Farm Management - Daily Expense Information</div>
                        <div class="card-body">
                            ...
                            <form action="{{ route('daily_expense.store') }}" method="post"
