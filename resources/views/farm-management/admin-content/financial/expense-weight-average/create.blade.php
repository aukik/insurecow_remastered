                    ...
                    >
                        <div class="col-auto mb-3">
                            <h1 class="page-header-title">
                                ...
                                Farm Management - Expense Weight Average
                            </h1>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-xl px-4 mt-4">
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">Farm Management - Expense Weight Average</div>
                        <div class="card-body">
                            ...
                            <form action="{{ route('expense.store') }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row gx-3 mb-3">
                                            <div class="col-md-12">
                                                <label for="description" class="small mb-1">Item Name</label>
                                                <input
                                                    type="text"
                                                    class="form-control"
                                                    id="description"
