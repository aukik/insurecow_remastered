...
<head>
    ...
    <title>Insurecow - Farm Management Panel</title>
...
<nav
    ...
    <a class="navbar-brand pe-3 ps-4 ps-lg-2" href="#">Farm Management</a>
    <!-- Navbar Search Input-->
...
{{--            @endif--}}
                        ...
                        @if(auth()->user()->role == "f")
                            <x-sidebar.farm_management></x-sidebar.farm_management>
                        @endif
    ...
    <div id="layoutSidenav_content">
        ...
        <footer class="footer-admin mt-auto footer-light">
            <div class="container-xl px-4">
                <div class="row">
                    <div class="col-md-6 small">Copyright &copy; Insurecow 2023</div>
