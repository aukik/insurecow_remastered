...
//   ---------------------------------------------------------- Profit And loss calculation ----------------------------------------------------------
    ...
    //    ------------------------------------------------ Profit and loss calculation - Based on individual animal with report ------------------------------------------------

    Route::get('/profit-and-loss-report-individual', [ProfitAndLossController::class, 'generateReportBasedOnAnimal'])->name('profit-and-loss-report-individual');
